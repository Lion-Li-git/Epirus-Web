...
export const ECON_ENV_KEYS = ['EPIRUS_ECO_TARGET', 'EPIRUS_ECO_CAP', 'EPIRUS_ECO_DIVW',
  'EPIRUS_DIV_W', 'EPIRUS_DIV_K', 'EPIRUS_DIV_FORCE_GENS', 'EPIRUS_WALL_FILTER', 'EPIRUS_WALL_GAMES'];

/* 与 `js/train/evo.js` 的 `setEconomyReward(o)` / `economyReward()` 字段名对齐
 * （D77 拿这份去比"读到的键"与"setter 认的键"，漏一个就红）。 */
export const ECON_REWARD_KEYS = ['target', 'cap', 'divW', 'divK', 'divForceGens', 'wallFilter', 'wallGames'];
